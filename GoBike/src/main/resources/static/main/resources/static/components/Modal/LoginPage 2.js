...
import CardBody from "/static/components/assets/components/Card/CardBody";
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "h4",
            { style: { font: 'inherit', fontSize: '30px', display: 'flex', justifyContent: 'center', alignItems: 'center' } },
            "Log Into GoBike"
          ),
          React.createElement(
            "h4",
            { style: { fontSize: "30px", alignItems: "center", textAlign: "center" } },
            React.createElement(FacebookIcon, { style: { fontSize: "30px", alignItems: "center", textAlign: "center" } })
          )
        ),
        React.createElement(
          CardBody,
          ...
          React.createElement(
            ...
            React.createElement(
              "p",
              { style: { font: 'inherit', fontSize: '16px', display: 'flex', justifyContent: 'center', alignItems: 'center', fontWeight: '30px' } },
              "First Time User?"
            ),
            React.createElement(
              Link,
              { style: { textDecorationLine: "none" }, to: "register" },
              React.createElement(
                Button,
          ...
          React.createElement(
            ...
            React.createElement(
              Link,
              { style: { textDecorationLine: "none", textAlign: 'left' }, to: "forgotpassword/email" },
              React.createElement(
                Button,
                { style: { font: 'inherit', fontSize: '16px', fontWeight: '30px', textAlign: 'left', margin: '0 0 10 0' }, color: "primary", simple: true },
                "Forgot password?"
              )
            )
          ),
