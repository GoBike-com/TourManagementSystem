...
export default function NavPills(props) {
  ...
  var tabContent = React.createElement("div", { className: classes.contentWrapper }, React.createElement(SwipeableViews, {
  ...
  return horizontal !== undefined ? React.createElement(GridContainer, null, React.createElement(GridItem, horizontal.tabsGrid, tabButtons), React.createElement(GridItem, horizontal.contentGrid, tabContent)) : React.createElement("div", null, tabButtons, tabContent);
}
