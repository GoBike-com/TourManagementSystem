...
export default function CustomDropdown(props) {
  ...
  switch (typeof buttonIcon === "undefined" ? "undefined" : _typeof(buttonIcon)) {
    case "object":
      ...
      break;
    case "string":
      icon = React.createElement(Icon, { className: classes.buttonIcon }, props.buttonIcon);
      break;
    default:
      icon = null;
      break;
  }
  return React.createElement("div", null, React.createElement("div", null, React.createElement(Button, Object.assign({
    "aria-label": "Notifications",
    "aria-owns": anchorEl ? "menu-list" : null,
    "aria-haspopup": "true"
  }, buttonProps, {
    onClick: handleClick
  }), icon, buttonText !== undefined ? buttonText : null, caret ? React.createElement("b", { className: caretClasses }) : null)), React.createElement(Popper, {
    ...
    }, React.createElement(Paper, { className: classes.dropdown }, React.createElement(ClickAwayListener, { onClickAway: handleCloseAway }, React.createElement(MenuList, { role: "menu", className: classes.menuList }, dropdownHeader !== undefined ? React.createElement(MenuItem, {
