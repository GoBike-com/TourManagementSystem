...
export default function CustomTabs(props) {
  ...
  return React.createElement(Card, { plain: plainTabs }, React.createElement(CardHeader, { color: headerColor, plain: plainTabs }, title !== undefined ? React.createElement("div", { className: cardTitle }, title) : null, React.createElement(Tabs, {
    value: value,
